      ...
      <div className="mx-60 space-y-6">
        <div className="border-[#000000]/20 border-2 rounded-xl p-4 px-20 min-h-screen">
          ...
          <section className="bg-white p-6">
            ...
            <div className="flex items-center justify-between border-[#000000]/50 border border-e-[3px] border-b-[3px] rounded-[10px] w-full p-4 px-28 h-24">
              <div className="flex flex-col items-center">
                <div className="font-bold text-[20px]">{profile.totalProjects}</div>
              ...
              <div className="flex flex-col items-center">
                <div className="font-bold text-[20px]">{profile.openedProjects}</div>
              ...
              <div className="flex flex-col items-center">
                <div className="font-bold text-[20px]">{profile.closedProjects}</div>
          ...
          <section className="bg-white p-6">
            ...
            <div className="flex items-center justify-between border-[#000000]/50 border border-e-[3px] border-b-[3px] rounded-[10px] w-full p-4 px-28 h-24">
              <div className="flex flex-col items-center">
                <div className="font-bold text-[20px]">{profile.totalApplications}</div>
                <div className="font-semibold text-[#B4B4B4] text-[12px]">전체</div>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="font-bold text-[20px]">{profile.pendingApplications}</div>
